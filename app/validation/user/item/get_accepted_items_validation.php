...
class get_accepted_items_validation implements validation_interface
{
    ...
    {
        return $this->params_exist(["page","requested"],$this->params) ? $this : $this->response(["key"=>"fail","msg"=>"wrong_parameters"]);
    }
    private function params_is_int()
    {
        if(!($this->num($this->params["page"]) && $this->num($this->params["requested"]))){
