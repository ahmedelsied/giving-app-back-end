...
class auth_user
{
    ...
    {
        return class_factory::create_instance("models\user")->where(["id","=",$this->headers["user_id"]],["auth_token","=",$this->headers["auth_token"]])->is_exist() ? null : $this->response(["key"=>"fail","msg"=>"auth_error"]);
    }
}